...
# PHP: JavaScript, The API (23-35)

Prezentowane zadania są przygotowane na podstawie rozdziału ["The DOM" (23-35)](https://laracasts.com/series/javascript-essentials-for-php-developers/episodes/23) dla kursu "[JavaScript Essentials for PHP Developers](https://laracasts.com/series/javascript-essentials-for-php-developers)". Użyj [linku polecającego](https://laracasts.com/referral/bogolubow), aby się zarejestrować i docenić moją pracę.
